import SleepLayout from "../../../layout/home-care/sleep/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const Sleep = () => {
  const [metaData, setMetaData] = useState({
    title: "Sleep Study Kaivee Healthcare.",
    description:
      "Sleep Study Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/sleep", // Replace with the canonical URL of the page
    image:

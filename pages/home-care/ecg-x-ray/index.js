import EcgLayout from "../../../layout/home-care/ecg-x-ray/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const ECG = () => {
  const [metaData, setMetaData] = useState({
    title: "Ecg & X-ray Kaivee Healthcare.",
    description:
      "Ecg & X-ray Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/ecg", // Replace with the canonical URL of the page
    image:

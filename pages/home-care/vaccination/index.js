import EcgLayout from "../../../layout/home-care/vaccination/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const ECG = () => {
  const [metaData, setMetaData] = useState({
    title: "Vaccination at home || Kaivee Healthcare.",
    description:
      "Vaccination at home Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/vaccination", // Replace with the canonical URL of the page
    image:

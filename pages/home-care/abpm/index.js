import EcgLayout from "../../../layout/home-care/abpm/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const Abpm = () => {
  const [metaData, setMetaData] = useState({
    title: "ABPM Kaivee Healthcare.",
    description:
      "ABPM Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/abpm", // Replace with the canonical URL of the page
    image:

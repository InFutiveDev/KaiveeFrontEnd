import EcgLayout from "../../../layout/home-care/holter/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const ECG = () => {
  const [metaData, setMetaData] = useState({
    title: "Holter Monitoring Kaivee Healthcare.",
    description:
      "Holter Monitoring Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/holter", // Replace with the canonical URL of the page
    image:

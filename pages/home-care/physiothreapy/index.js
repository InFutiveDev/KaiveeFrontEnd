import EcgLayout from "../../../layout/home-care/physiothreapy/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const Physio = () => {
  const [metaData, setMetaData] = useState({
    title: "Physiothreapy at Home || Kaivee Healthcare.",
    description:
      "Physiothreapy at Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/physiothreapy", // Replace with the canonical URL of the page
    image:

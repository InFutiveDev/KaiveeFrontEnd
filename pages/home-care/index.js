import { HomeCareLayout } from "../../layout";
import { useEffect, useState } from "react";
import Head from "next/head";

const HomeCare = () => {
  const [metaData, setMetaData] = useState({
    title: "HomeCare Kaivee Healthcare.",
    description:
      "HomeCare Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/home-care", // Replace with the canonical URL of the page
    image:

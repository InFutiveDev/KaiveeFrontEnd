import EcgLayout from "../../../layout/home-care/blood-sample/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const BloodSample = () => {
  const [metaData, setMetaData] = useState({
    title: "Blood Sample Collection at Kaivee Healthcare.",
    description:
      "Blood Sample Collection at Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/blood-sample", // Replace with the canonical URL of the page
    image:

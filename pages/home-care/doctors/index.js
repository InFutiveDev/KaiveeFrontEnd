import EcgLayout from "../../../layout/home-care/doctors/index";
import { useEffect, useState } from "react";
import Head from "next/head";

const Doctors = () => {
  const [metaData, setMetaData] = useState({
    title: "Doctors at Kaivee Healthcare.",
    description:
      "Doctors at Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/doctors", // Replace with the canonical URL of the page
    image:

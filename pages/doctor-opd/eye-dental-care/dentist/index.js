import  AlternativeLayout  from "../../../../layout/doctor-opd/eye-dental-care/dentist";
import { useEffect, useState } from "react";
import Head from "next/head";

const AlternativeMed = () => {
  const [metaData, setMetaData] = useState({
    title: " Dental Care at Kaivee Healthcare.",
    description:
      "Dental Care at Kaivee Healthcare | Various Alternative Medicine in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/doctor-opd/eye-dental-care/dentist", // Replace with the canonical URL of the page
    image:

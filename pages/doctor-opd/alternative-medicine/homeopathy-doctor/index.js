import  AlternativeLayout  from "../../../../layout/doctor-opd/alternative-medicine/homeopathy-doctor";
import { useEffect, useState } from "react";
import Head from "next/head";

const AlternativeMed = () => {
  const [metaData, setMetaData] = useState({
    title: "Homeopathy-doctor Kaivee Healthcare.",
    description:
      "Alternative Medicine Kaivee Healthcare | Various Alternative Medicine in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/doctor-opd/alternative-medicine/homeopathy-doctor", // Replace with the canonical URL of the page
    image:

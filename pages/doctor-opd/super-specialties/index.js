import  AlternativeLayout  from "../../../layout/doctor-opd/super-specialties";
import { useEffect, useState } from "react";
import Head from "next/head";

const AlternativeMed = () => {
  const [metaData, setMetaData] = useState({
    title: "Super Specialties Kaivee Healthcare.",
    description:
      "Super Specialties Kaivee Healthcare | Various Alternative Medicine in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/doctor-opd/super-specialties", // Replace with the canonical URL of the page
    image:

import  AlternativeLayout  from "../../../../layout/doctor-opd/super-specialties/neurologist";
import { useEffect, useState } from "react";
import Head from "next/head";

const AlternativeMed = () => {
  const [metaData, setMetaData] = useState({
    title: "Neurologist Kaivee Healthcare.",
    description:
      "Neurologist Kaivee Healthcare | Various Alternative Medicine in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/doctor-opd/super-specialties/neurologist", // Replace with the canonical URL of the page
    image:

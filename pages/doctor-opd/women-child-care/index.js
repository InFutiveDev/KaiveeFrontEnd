import  AlternativeLayout  from "../../../layout/doctor-opd/women-child-care";
import { useEffect, useState } from "react";
import Head from "next/head";

const AlternativeMed = () => {
  const [metaData, setMetaData] = useState({
    title: "Women & Child Care  Kaivee Healthcare.",
    description:
      "Women & Child Care Kaivee Healthcare | Various Alternative Medicine in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/doctor-opd/women-child-care", // Replace with the canonical URL of the page
    image:

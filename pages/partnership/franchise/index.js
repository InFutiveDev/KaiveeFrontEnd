import EcgLayout from "../../../layout/partnership/franchise/index";
...
const Franchise = () => {
  const [metaData, setMetaData] = useState({
    title: "Franchise of Kaivee Healthcare.",
    description:
      "Franchise of Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/franchise", // Replace with the canonical URL of the page
    image:

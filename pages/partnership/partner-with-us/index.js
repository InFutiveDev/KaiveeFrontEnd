import EcgLayout from "../../../layout/partnership/partner-with-us/index";
...
const PartnerWithUs = () => {
  const [metaData, setMetaData] = useState({
    title: "Partner with  Kaivee Healthcare.",
    description:
      "Partner with Kaivee Healthcare | Various Home Care Specialist in Delhi-NCR",
    url: "https://www.kaiveehealthcare.com/partner-with-us", // Replace with the canonical URL of the page
    image:

        ...
        <>
            ...
            <div className=" min-h-[50vh] my-5 flex flex-col items-center container mx-auto bg-[#F7A708]/20 rounded-xl text-center p-2">
                ...
                <div className="my-2 flex justify-start items-center space-x-2">
                    <Link href='/' className=" bg-orange text-white shadow px-4 py-1 rounded-lg text-[18px]">
                        Home
                    </Link>
                    <Link href='/dashboard/my-booking' className=" bg-white border-[1px] border-orange text-orange px-3 py-1 rounded-lg text-[18px]">
                        My Booking
                    </Link>

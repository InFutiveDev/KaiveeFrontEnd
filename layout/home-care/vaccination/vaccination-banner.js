  ...
  return (
    <div className="w-full">
      <div className="2xl:pl-[10rem] xl:pl-[4rem] lg:pl-[1rem] pl-[16px]">
        <BreadCrumb active="Vaccination" breadcrumblist={breadcrumblist} />
      </div>
      <div className="relative w-full  items-center hidden sm:flex">
        <Image
          ...
          src={"https://ik.imagekit.io/InFutiveTechnology/kaivee/WhatsApp%20Image%202025-03-26%20at%2016.51.56.jpg?updatedAt=1743047400109?tr=f-auto,q-80"}
        />
      </div>
...
export default Vaccinationnbanner;

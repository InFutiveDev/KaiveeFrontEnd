...
const breadcrumblist = [{ name: "Doctor's OPD > Women & Child Care ", path: "/doctor-opd/women-child-care" }];
  ...
  return (
    <div className="w-full">
      <div className="2xl:pl-[10rem] xl:pl-[4rem] lg:pl-[1rem] pl-[16px]">
        <BreadCrumb active="Gynecologist" breadcrumblist={breadcrumblist} />
      </div>
      <div className="relative w-full  items-center hidden sm:flex">
        <Image
          ...
          src="https://ik.imagekit.io/InFutiveTechnology/kaivee/WhatsApp%20Image%202025-04-25%20at%2012.47.44.jpg?updatedAt=1745582148717?tr=f-auto,q-80"
        />
      </div>

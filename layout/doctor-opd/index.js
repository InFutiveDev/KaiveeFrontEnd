import Doctorbanner from "./alternative-medicine/alternative-banner";
...
const DoctorOPDLayout = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="flex justify-center">
      <Image src={OurVersion} alt="Doctor Consultation" className="rounded-xl shadow-md w-[80%] max-w-[500px]" />
    </div>
  </div>

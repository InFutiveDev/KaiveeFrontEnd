  ...
  return (
    <div className="w-full">
      <div className="2xl:pl-[10rem] xl:pl-[4rem] lg:pl-[1rem] pl-[16px]">
        <BreadCrumb active="Alternative Medicine & Rehabilitaion" breadcrumblist={breadcrumblist} />
      </div>
      <div className="relative w-full  items-center hidden sm:flex">
        <Image
          ...
          src="https://ik.imagekit.io/InFutiveTechnology/kaivee/WhatsApp%20Image%202025-05-02%20at%2011.55.47.jpg?updatedAt=1746169433874?tr=f-auto,q-80"
        />
      </div>

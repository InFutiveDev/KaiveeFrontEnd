  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="py-7 mt-6 flex justify-center items-center flex-col bg-[#F7F7FB] rounded-lg container text-center mx-auto">
        ...
        <div className=" lg:w-3/4 w-full flex   sm:flex-row  flex-col mt-4  gap-2  items-center  justify-center space-x-2">
          <input
            type="email"
          ...
          <button
            // type="button"
            className="min-w-[170px]  max-w-[170px] w-full h-full py-2  !m-0 rounded-md bg-[#fcc42f] "
